...
public class MonkeyLearnClient {
	private static final String API_KEY = "63b05b7f372945f72c8499d82a1777c41fcf4cd4";// make sure change it to your api key.
	
    public static void main(String[] args) {
    	//string of array, batch processing
		String[] textList = {
				"software engineer",
	...
	public static List<List<String>> extractKeywords(String[] text) {
		...
		try {
			response = ml.extractors.extract("ex_YCya9nrn", text, extraParams);  //edit model 
